...
public class ForecastAdapter extends CursorAdapter {
    ...
    private boolean mUseToadyLayout;
    ...
    public int getItemViewType(int position) {
        return (position == 0 && mUseToadyLayout) ? VIEW_TYPE_TODAY : VIEW_TYPE_FUTURE_DAY;
    }

    public void setUseToadyLayout(boolean value){
        mUseToadyLayout = value;
    }
